...
<body>
    ...
    <tr><td> เพศ:</td>
        <td>
            ...
            <input type="radio" name="gender" value="famale"> หญิง<br>
            <input type="radio" name="gender" value="orther"> อื่นๆ<br>

    </td></tr>
    <tr><td>อีเมล:</td><td><input type="text" name="mail" size="40"></td></tr>
    <tr><td colspan="2" align="center"><input type="submit" value="สมัครสมาชิก"a></td></tr>
    </table>
    <br>
    <div align="center">
